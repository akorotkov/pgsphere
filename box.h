...
{
	SPoint		sw;
	/* !<South - west value of box */
	SPoint		ne;
	/* !<North - east value of box */
} SBOX;
...
/*! @} */
 ...
 /*
  * ! \brief Checks , whether two boxes are equal \param b1 pointer to first
  * box \param b2 pointer to second box \return true, if equal
  */
bool		sbox_eq(SBOX *b1, SBOX *b2);

 /*
  * ! \brief Checks , whether point is contained by a box \param p	pointer to
  * point \param b	pointer to box \return true, if box contains point
  */
bool		sbox_cont_point(const SBOX *b, const SPoint *p);


 /*
  * ! \brief Input function of box \return box datum \note PostgreSQL function
  */
Datum		spherebox_in(PG_FUNCTION_ARGS);

 /*
  * ! The first point is the south-west position, the second the north-east
  * position. \brief Input function of box from two points \return box datum
  * \note PostgreSQL function
  */
Datum		spherebox_in_from_points(PG_FUNCTION_ARGS);

 /*
  * ! \brief Returns the south-west edge of box \return point datum \note
  * PostgreSQL function
  */
Datum		spherebox_sw(PG_FUNCTION_ARGS);

 /*
  * ! \brief Returns the north-east edge of box \return point datum \note
  * PostgreSQL function
  */
Datum		spherebox_ne(PG_FUNCTION_ARGS);

 /*
  * ! \brief Returns the south-east edge of box \return point datum \note
  * PostgreSQL function
  */
Datum		spherebox_se(PG_FUNCTION_ARGS);

 /*
  * ! \brief Returns the north-west edge of box \return point datum \note
  * PostgreSQL function
  */
Datum		spherebox_nw(PG_FUNCTION_ARGS);

 /*
  * ! \brief Returns the area of a box \return float8 datum \note PostgreSQL
  * function
  */
Datum		spherebox_area(PG_FUNCTION_ARGS);

 /*
  * ! \brief Returns the circumference of a box \return float8 datum \note
  * PostgreSQL function
  */
Datum		spherebox_circ(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks, wheter two boxes are equal \return boolean datum \note
  * PostgreSQL function
  */
Datum		spherebox_equal(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks, wheter two boxes are not equal \return boolean datum
  * \note PostgreSQL function
  */
Datum		spherebox_equal_neg(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether point is contained by a box \return boolean
  * datum \note PostgreSQL function
  */
Datum		spherebox_cont_point(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether point isn't contained by a box \return boolean
  * datum \note PostgreSQL function
  */
...
Datum		spherebox_cont_point_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether box contains a circle \return boolean datum
  * \note PostgreSQL function
  */
Datum		spherebox_cont_circle(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether box doesn't contain a circle \return boolean
  * datum \note PostgreSQL function
  */
...
Datum		spherebox_cont_circle_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether circle contains a box \return boolean datum
  * \note PostgreSQL function
  */
Datum		spherecircle_cont_box(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether circle doesn't contain a box \return boolean
  * datum \note PostgreSQL function
  */
...
Datum		spherecircle_cont_box_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether circle and box are overlapping \return boolean
  * datum \note PostgreSQL function
  */
Datum		spherebox_overlap_circle(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether circle and box aren't overlapping \return
  * boolean datum \note PostgreSQL function
  */
...
Datum		spherebox_overlap_circle_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether box contains line \return boolean datum \note
  * PostgreSQL function
  */
Datum		spherebox_cont_line(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether box doesn't contain line \return boolean datum
  * \note PostgreSQL function
  */
...
Datum		spherebox_cont_line_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether box and line are overlapping \return boolean
  * datum \note PostgreSQL function
  */
Datum		spherebox_overlap_line(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether box and line aren't overlapping \return boolean
  * datum \note PostgreSQL function
  */
...
Datum		spherebox_overlap_line_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether box contains path \return boolean datum \note
  * PostgreSQL function
  */
Datum		spherebox_cont_path(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether box doesn't contain path \return boolean datum
  * \note PostgreSQL function
  */
...
Datum		spherebox_cont_path_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether box and path are overlapping \return boolean
  * datum \note PostgreSQL function
  */
Datum		spherebox_overlap_path(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether box and path aren't overlapping \return boolean
  * datum \note PostgreSQL function
  */
...
Datum		spherebox_overlap_path_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether box contains a polygon \return boolean datum
  * \note PostgreSQL function
  */
Datum		spherebox_cont_poly(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether box doesn't contain a polygon \return boolean
  * datum \note PostgreSQL function
  */
...
Datum		spherebox_cont_poly_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether polygon contains a box \return boolean datum
  * \note PostgreSQL function
  */
Datum		spherepoly_cont_box(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether polygon doesn't contain a box \return boolean
  * datum \note PostgreSQL function
  */
...
Datum		spherepoly_cont_box_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether polygon and box are overlapping \return boolean
  * datum \note PostgreSQL function
  */
Datum		spherebox_overlap_poly(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether polygon and box aren't overlapping \return
  * boolean datum \note PostgreSQL function
  */
...
Datum		spherebox_overlap_poly_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether box contains a ellipse \return boolean datum
  * \note PostgreSQL function
  */
Datum		spherebox_cont_ellipse(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether box doesn't contain a ellipse \return boolean
  * datum \note PostgreSQL function
  */
...
Datum		spherebox_cont_ellipse_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether ellipse contains a box \return boolean datum
  * \note PostgreSQL function
  */
Datum		sphereellipse_cont_box(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether ellipse doesn't contain a box \return boolean
  * datum \note PostgreSQL function
  */
...
Datum		sphereellipse_cont_box_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether ellipse and box are overlapping \return boolean
  * datum \note PostgreSQL function
  */
Datum		spherebox_overlap_ellipse(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether ellipse and box aren't overlapping \return
  * boolean datum \note PostgreSQL function
  */
...
Datum		spherebox_overlap_ellipse_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether a box contains another box \return boolean datum
  * \note PostgreSQL function
  */
Datum		spherebox_cont_box(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether box doesn't contain another box \return boolean
  * datum \note PostgreSQL function
  */
Datum		spherebox_cont_box_neg(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether box contains another box \return boolean datum
  * \note PostgreSQL function
  */
...
Datum		spherebox_cont_box_com_neg(PG_FUNCTION_ARGS);
 ...
 /*
  * ! \brief Checks , whether boxes are overlapping \return boolean datum
  * \note PostgreSQL function
  */
Datum		spherebox_overlap_box(PG_FUNCTION_ARGS);

 /*
  * ! \brief Checks , whether boxes aren't overlapping \return boolean datum
  * \note PostgreSQL function
  */
