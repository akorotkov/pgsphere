...
PG_FUNCTION_INFO_V1(pg_sphere_version);
 ...
 /*
  * ! \brief set the output modus \return the set modus as varchar \note
  * PostgreSQL function
  */
Datum		set_sphere_output(PG_FUNCTION_ARGS);

 /*
  * ! \brief set the output precision \return the set number of decimal digits
  * as int \note PostgreSQL function
  */
Datum		set_sphere_output_precision(PG_FUNCTION_ARGS);

 /*
  * ! \brief the output function of spherical point \return cstring \note
  * PostgreSQL function
  */
Datum		spherepoint_out(PG_FUNCTION_ARGS);

 /*
  * ! \brief the output function of spherical circle \return cstring \note
  * PostgreSQL function
  */
Datum		spherecircle_out(PG_FUNCTION_ARGS);

 /*
  * ! \brief the output function of spherical line \return cstring \note
  * PostgreSQL function
  */
Datum		sphereline_out(PG_FUNCTION_ARGS);

 /*
  * ! \brief the output function of Euler transformation \return cstring \note
  * PostgreSQL function
  */
Datum		spheretrans_out(PG_FUNCTION_ARGS);

 /*
  * ! \brief the output function of spherical polygon \return cstring \note
  * PostgreSQL function
  */
Datum		spherepoly_out(PG_FUNCTION_ARGS);

 /*
  * ! \brief the output function of spherical path \return cstring \note
  * PostgreSQL function
  */
Datum		spherepath_out(PG_FUNCTION_ARGS);

 /*
  * ! \brief the output function of spherical ellipse \return cstring \note
  * PostgreSQL function
  */
Datum		sphereellipse_out(PG_FUNCTION_ARGS);

 /*
  * ! \brief the output function of spherical box \return cstring \note
  * PostgreSQL function
  */
Datum		spherebox_out(PG_FUNCTION_ARGS);

 /*
  * ! \brief output of version \return cstring \note PostgreSQL function
  */
Datum		pg_sphere_version(PG_FUNCTION_ARGS);


 /*
  * ! \brief Converts radians to DEG ( degrees, minutes, seconds ) \param rad
  * input in radians \param deg pointer to degrees \param min pointer to
  * minutes \param sec pointer to seconds \return nothing \note PostgreSQL
  * function
  */
static void
