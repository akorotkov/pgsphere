...
void		sphere_flush_scanner_buffer(void);
 ...
 /*
  * ! \brief Sets the data type \return type number
  */
void		set_spheretype(unsigned char st);

 /*
  * ! \brief Initialize the input buffer \param buffer pointer to input buffer
  */
...
void		reset_buffer(void);
 ...
 /*
  * ! \brief Read the input \param buf pointer to buffer \param offset number
  * of bytes \return count of read bytes
  */
int			get_buffer(char *buf, int offset);

 /*
  * ! \brief input of a angle \param is_deg >0 if a in degrees \param a value
  * of angle \return a unique ID ( position) of angle
  */
int			set_angle(unsigned char is_deg, double a);

 /*
  * ! \brief set the sign of an angle \param apos the angle ID \param s sign
  * of angle ( <0 .. - , >0 .. + ) \return the unique ID ( position) of angle
  */
int			set_angle_sign(int apos, int s);

 /*
  * ! \brief Creates a spherical point \param lngpos the ID of longitude angle
  * \param latpos the ID of latitude angle \return the unique ID ( position)
  * of spherical point
  */
int			set_point(int lngpos, int latpos);

 /*
  * ! \brief Creates a spherical circle \param spos the ID of spherical point
  * \param rpos the ID of radius angle
  */
void		set_circle(int spos, int rpos);

 /*
  * ! \brief Sets the length of spherical line \param length the ID of length
  * angle
  */
void		set_line(int length);

 /*
  * ! \brief Creates an Euler transformation \param phi the ID of first angle
...
void		set_euler(int phi, int theta, int psi, char *etype);
 ...
 /*
  * ! \brief Creates a spherical ellipse \param r1 ID of first radius angle
...
void		set_ellipse(int r1, int r2, int sp, int inc);
 ...
 /*
  * ! \brief Returns the point parameters \param lng pointer to longitude
...
int			get_point(double *lng, double *lat);
 ...
 /*
  * ! \brief Returns the circle parameters \param lng pointer to longitude
...
int			get_circle(double *lng, double *lat, double *radius);
 ...
 /*
  * ! \brief Returns the ellipse parameters \param lng pointer to longitude
...
int get_ellipse(double *lng, double *lat, double *r1,
 ...
 /*
  * ! \brief Returns the line parameters \param phi   pointer to first angle
...
int get_line(double *phi, double *theta, double *psi,
 ...
 /*
  * ! \brief Returns the Euler transformation parameters \param phi   pointer
...
int get_euler(double *phi, double *theta,
 ...
 /*
  * ! \brief Returns the count of path elements \return count of points
  */
int			get_path_count(void);

 /*
  * ! \brief Returns the elements of path \param spos number of element \param
...
int			get_path_elem(int spos, double *lng, double *lat);
 ...
 /*
  * ! \brief Returns the elements of box \param lng1 the ID of first longitude
