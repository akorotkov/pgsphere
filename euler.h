 ...
 * theta, psi) in radians.
 */
Datum		spheretrans_from_float8(PG_FUNCTION_ARGS);

/*
 * Returns the first angle of Euler transformation in radians.
 */
Datum		spheretrans_phi(PG_FUNCTION_ARGS);

/*
 * Returns the second angle of Euler transformation in radians.
 */
Datum		spheretrans_theta(PG_FUNCTION_ARGS);

/*
 * Returns the third angle of Euler transformation in radians.
 */
Datum		spheretrans_psi(PG_FUNCTION_ARGS);

/*
 * Returns the axis of Euler transformation as three letter code.
 */
...
/*
 * Transforms an Euler transformations.
 */
